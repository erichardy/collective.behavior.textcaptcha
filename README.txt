...
Réponses aux questions de ``sphinx-quickstart``
-----------------------------------------------

[collective.behavior.textcaptcha (master)⚡]> bin/sphinx-quickstart
...
> Project name: collective.behavior.textcaptcha
> Author name(s): Eric Hardy
